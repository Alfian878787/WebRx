...
module wx {
    ...
    **/
    ...
    /* @interface
    **/
    export interface IObservableReadOnlyList<T> extends IList<T>, INotifyListChanged<T>  {
    ...
    /* @interface
    **/
    export interface IProjectableObservableReadOnlyList<T> extends IObservableReadOnlyList<T>, INotifyListItemChanged {
        /**
